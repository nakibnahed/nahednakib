...
import {
  MessageCircle, BookOpen, Briefcase,
    ...
    <div className={be.pageRoot}>
      <header className={styles.hero}>
        ...
        <div className={styles.heroTitleRow}>
          <div className={styles.heroIcon}><MessageCircle size={17} strokeWidth={1.75} /></div>
          <h1 className={styles.heroTitle}>My comments</h1>
        </div>
        <p className={styles.heroLead}>Delete a comment or open the post it belongs to.</p>
      </header>
